    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center px-8">
        ...
        >
          <Link
            href="/contact"
            className="group relative inline-flex items-center gap-3 px-5 py-2.5 overflow-hidden font-bold text-black rounded-full transition-all duration-300 bg-gradient-to-r from-[#FFCC00] via-[#FFB300] to-[#FF6600] shadow-[0_4px_20px_rgba(255,165,0,0.3)] hover:shadow-[0_6px_25px_rgba(255,165,0,0.4)]"
          >
