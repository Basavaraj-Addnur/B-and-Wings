...
const projects = [
  {
    ...
    image: "/freedomtv.png",
    description: "Developed a modern digital platform for Freedom TV enabling online media publishing, real-time news distribution, and scalable content delivery for a growing audience.",
    link: "https://freedomtv.in",
  ...
  },
  {
    ...
    description: "Designed and developed a modern website for Bangalore Fashion Trainings to showcase courses, admissions, and student programs with an engaging visual design.",
